...
### Subgroup
 ...
 - Gonçalo Querido, 89447, GonQue
   + Issues assigned: [#175](https://github.com/tecnico-softeng/es20al_16-project/issues/175), [#184](https://github.com/tecnico-softeng/es20al_16-project/issues/184), 
...
#### Feature number 1 and 2: _Uma questão aprovada pode passar a fazer parte do conjunto de perguntas disponíveis. Um docente pode alterar uma pergunta aprovada antes de a colocar como fazendo parte do conjunto de perguntas disponíveis_
 ...
 - [x] [Service](https://github.com/tecnico-softeng/es20al_16-project/blob/P4)
 ...
 - [x] [Cypress use case test](https://github.com/tecnico-softeng/es20al_16-project/blob/P4/frontend/tests/e2e/specs/teacher/evaluateProposedQuestions.js#L31)
   + Screenshot: 
     ![Test results]()
