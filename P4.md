...
#### Feature number 4 and 5: _Uma questão aprovada pode passar a fazer parte do conjunto de perguntas disponíveis. Um docente pode alterar uma pergunta aprovada antes de a colocar como fazendo parte do conjunto de perguntas disponíveis_
 ...
 - [x] [Cypress use case test](https://github.com/tecnico-softeng/es20al_16-project/blob/P4/frontend/tests/e2e/specs/proposedQuestions/proposedQuestionsTests.js#L26)
   + Screenshot: 
...
#### Feature number 6: _Uma pergunta rejeitada pode ser alterada e resubmetida pelo aluno_
 ...
 - [x] [Cypress use case test](https://github.com/tecnico-softeng/es20al_16-project/blob/P4/frontend/tests/e2e/specs/proposedQuestions/proposedQuestionsTests.js#L36)
 + Screenshots: 
