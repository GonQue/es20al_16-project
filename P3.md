...
The list of pull requests associated with this feature is:
 ...
 - [PR #x](https://github.com/tecnico-softeng/es20al_16-project/pull/x)
...
### Additional services implemented
 ...
 - [Service 1](https://github.com/tecnico-softeng/es20al_16-project/blob/P3/)
    + [Controller](https://github.com/tecnico-softeng/es20al_16-project/blob/P3/)
    + [Spock tests](https://github.com/tecnico-softeng/es20al_16-project/blob/P3/)
    + [Feature test (JMeter)](https://github.com/tecnico-softeng/es20al_16-project/blob/P3/)
